                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">{data?.count || 0} registros encontrados</p>
                            </div>
                        </div>
                        <button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div className="md:col-span-2">
                            ...
                            <input
                                ...
                                placeholder="Número OS, cliente, chassi..."
                                        ...
                                        {data.data.map((os: any) => (
                                            <tr key={os.id} className="hover:bg-gray-50 transition">
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="text-sm font-medium text-gray-900">{os.numero_os}</div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <span className={`px-2 py-1 rounded text-xs font-medium ${os.tipo_os === 'NORMAL' ? 'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800'
                                                        }`}>
                                                        {os.tipo_os === 'NORMAL' ? 'N' : 'W'}
                                                    </span>
                                                </td>
                                                <td className="px-6 py-4">
                                                    <div className="text-sm text-gray-900">{os.nome_cliente_digitavel || '-'}</div>
                                                    {os.chassi && (
                                                        <div className="text-xs text-gray-500">Chassi: {os.chassi}</div>
                                                    )}
                                                </td>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    {getStatusBadge(os.status_atual)}
                                                </td>
